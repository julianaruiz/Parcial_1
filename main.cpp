...
int main()
{
    float v_o, angu_o, h1, h2, d, x_max, y_max, a, b, c, t1, t2, t, x_t0, y_t0, x_max_D, y_max_D;
    ...
    if (x_max==(d-0.05) || x_max==(d-0.04) || x_max==(d-0.03) || x_max==(d-0.02) || x_max==(d-0.01) || x_max==d){ //el disparo alcanza al cañón.
        ...
        x_t0=v_o*(cos(angu_o*pi/180))*t_0; //mide la distancia en x que a avanzado hasta t=2,5.
        y_t0=h1+v_o*sin(angu_o*pi/180)*t_0-g/2*pow(t_0,2); //mide la distancia en y que a avanzado hasta t=2,5.
